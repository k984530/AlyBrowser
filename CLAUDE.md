...
|--------|-------|----------|
| bridge.ts | 105 | 96% (Stmts/Branch/Funcs/Lines) |
| screen.ts | 28 | 100% |
| content-snapshot | 19 | — (happy-dom) |
| other modules | 71 | — |
| **Total** | **223** | — |

## Tools

43 MCP tools total: browser control (5), page reading (3), interaction (8), tabs (4), frames (1), cookies (3), downloads (1), history (1), alarms (4), storage (2), notifications (1), bookmarks (3), clipboard (2), sessions (2), screen (5), sleep (1).
