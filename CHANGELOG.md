...
- **`browser_fetch_intercept`**: Intercept fetch() API calls — capture method, URL, status, request/response bodies with credential masking and URL filter
- README.md updated: 49 → 126 tools across 29 categories
